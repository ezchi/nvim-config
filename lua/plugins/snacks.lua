return {
  ...
  opts = {
    ...
    styles = {
      notification = {
        -- wo = { wrap = true } -- Readonly on FileType
      }
    }
  },
  keys = {
    ...
    { "<leader>glf", function() Snacks.lazygit.log_file() end, desc = "Lazygit Current File Log" },
    { "<leader>glg", function() Snacks.lazygit() end, desc = "Lazygit" },
    { "<leader>gll", function() Snacks.lazygit.log() end, desc = "Lazygit Log (cwd)" },
